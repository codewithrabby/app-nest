...
const Home = () => {
    return (
      ...
      <h1 className="text-[#001931] text-7xl font-bold leading-tight">
        ...
        At App Nest, we craft innovative apps designed to make everyday life simpler,
        smarter, and more exciting. <br /> Our goal is to turn your ideas into digital experiences that truly make an impact.
      </p>


<div className="flex gap-4 mt-8">
  <button className="flex items-center gap-2 border border-gray-400 px-6 py-3 rounded-lg hover:bg-gray-100 transition">
    <img
      src={googleImg}
      alt="Google Play"
      className="w-6 h-6"
  ...
  <button className="flex items-center gap-2 border border-gray-400 px-6 py-3 rounded-lg hover:bg-gray-100 transition">
    ...
    <span>App Store</span>
      ...
      <p className="text-sm mb-4">Total Download</p> {/* p tag bottom margin */}
