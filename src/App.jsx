  ...
  return (
    <>
      <nav className="flex justify-between items-center max-w-7xl mx-auto h-[80px] px-6">
        ...
        <div className="flex items-center gap-8 text-lg font-medium">
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? "relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-[3px] after:bg-[#632EE3] text-[#632EE3] transition"
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="flex items-center gap-2 text-white px-4 py-2 rounded-lg bg-gradient-to-r from-[#632EE3] to-[#9F62F2] hover:opacity-90 transition"
          >
      ...
      <footer className="footer flex justify-between items-center sm:footer-horizontal bg-base-300 text-base-content p-10 bg-[#1E293B] text-white">
        ...
        <div>
          <h6 className="footer-title mb-4 text-2xl font-semibold text-center">
            Social
          </h6>
